...
// console.log(heroes);
// heroes.indexOf(1)
// console.log(heroes.indexOf("pk"));
// console.log(heroes.slice(0,3));
var cloth_brands=["venhussen","allensolly","roadster","denim"]
cloth_brands.push('7')
console.log(cloth_brands);
cloth_brands[2]="jhonplayers"
cloth_brands[100]="basics"
cloth_brands.push("tommy hilfiger")
console.log(cloth_brands);